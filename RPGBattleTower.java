...
public class RPGBattleTower {
    ...
    public static void main(String[] args) throws IOException,
        ...
        if (saveChoice == 2) {
            ...
            for (int i = 0; i < user.getInventory().size(); i++)
                usersItems.get(usersItems.size() - 1)[i] = user.getInventory().get(i);
    ...
    public static void readSaveFile(ArrayList<String[]> usersStats,
        ...
        // File reader objects
        File myFile = new File("RPGBattleTower/RPGSaveStates.txt");
    ...
    public static void sortUsers(ArrayList<String[]> usersStats,
        ...
        do {
            ...
            for (int i = 0; i < usersStats.size() - 1; i++) {
                if (usersStats.get(i)[0].compareToIgnoreCase(usersStats.get(i + 1)[0]) > 0) {
    ...
    public static void writeSaveStates(ArrayList<String[]> usersStats,
        ...
        // File writer objects
        FileWriter fWrite = new FileWriter("RPGBattleTower/RPGSaveStates.txt", false);
